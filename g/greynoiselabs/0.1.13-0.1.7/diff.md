# Comparing `tmp/greynoiselabs-0.1.13.tar.gz` & `tmp/greynoiselabs-0.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "greynoiselabs-0.1.13.tar", max compression
+gzip compressed data, was "greynoiselabs-0.1.7.tar", last modified: Thu Jul 27 18:38:35 2023, max compression
```

## Comparing `greynoiselabs-0.1.13.tar` & `greynoiselabs-0.1.7.tar`

### file list

```diff
@@ -1,26 +1,41 @@
--rw-r--r--   0        0        0     1079 2023-06-16 04:21:17.985676 greynoiselabs-0.1.13/LICENSE
--rw-r--r--   0        0        0     1171 2023-07-28 15:42:23.630742 greynoiselabs-0.1.13/README.rst
--rw-r--r--   0        0        0     2335 2023-07-28 17:13:33.960011 greynoiselabs-0.1.13/pyproject.toml
--rw-r--r--   0        0        0        0 2023-07-27 04:05:43.447421 greynoiselabs-0.1.13/src/greynoiselabs/__init__.py
--rw-r--r--   0        0        0     1611 2023-07-28 17:12:59.757190 greynoiselabs-0.1.13/src/greynoiselabs/api/__init__.py
--rw-r--r--   0        0        0     7371 2023-07-28 17:12:59.736519 greynoiselabs-0.1.13/src/greynoiselabs/api/async_base_client.py
--rw-r--r--   0        0        0     1951 2023-07-28 17:12:59.737034 greynoiselabs-0.1.13/src/greynoiselabs/api/base_model.py
--rw-r--r--   0        0        0     4296 2023-07-28 17:12:59.753150 greynoiselabs-0.1.13/src/greynoiselabs/api/client.py
--rw-r--r--   0        0        0       84 2023-07-28 17:13:00.859531 greynoiselabs-0.1.13/src/greynoiselabs/api/enums.py
--rw-r--r--   0        0        0     2366 2023-07-28 17:12:59.737239 greynoiselabs-0.1.13/src/greynoiselabs/api/exceptions.py
--rw-r--r--   0        0        0      461 2023-07-28 17:12:59.725100 greynoiselabs-0.1.13/src/greynoiselabs/api/generate_g_n_q_l.py
--rw-r--r--   0        0        0      593 2023-07-28 17:12:59.707682 greynoiselabs-0.1.13/src/greynoiselabs/api/get_c2s.py
--rw-r--r--   0        0        0      698 2023-07-28 17:12:59.735964 greynoiselabs-0.1.13/src/greynoiselabs/api/get_i_ps.py
--rw-r--r--   0        0        0      775 2023-07-28 17:12:59.719376 greynoiselabs-0.1.13/src/greynoiselabs/api/get_knocks.py
--rw-r--r--   0        0        0      689 2023-07-28 17:12:59.729868 greynoiselabs-0.1.13/src/greynoiselabs/api/get_noise_ranks.py
--rw-r--r--   0        0        0      755 2023-07-28 17:12:59.711204 greynoiselabs-0.1.13/src/greynoiselabs/api/get_requests.py
--rw-r--r--   0        0        0      221 2023-07-28 17:12:59.700948 greynoiselabs-0.1.13/src/greynoiselabs/api/input_types.py
--rw-r--r--   0        0        0      942 2023-07-27 01:19:27.930060 greynoiselabs-0.1.13/src/greynoiselabs/api/noise_rank.py
--rw-r--r--   0        0        0      220 2023-07-28 17:12:59.738957 greynoiselabs-0.1.13/src/greynoiselabs/api/scalars.py
--rw-r--r--   0        0        0     1138 2023-07-27 01:19:27.930299 greynoiselabs-0.1.13/src/greynoiselabs/api/top_h_t_t_p_requests.py
--rw-r--r--   0        0        0     1060 2023-07-27 01:19:27.930417 greynoiselabs-0.1.13/src/greynoiselabs/api/top_knocks.py
--rw-r--r--   0        0        0      993 2023-07-27 01:19:27.930530 greynoiselabs-0.1.13/src/greynoiselabs/api/top_popular_i_ps.py
--rw-r--r--   0        0        0        0 2023-07-27 03:55:22.108240 greynoiselabs-0.1.13/src/greynoiselabs/cli/__init__.py
--rwxr-xr-x   0        0        0     5913 2023-07-28 05:40:24.645818 greynoiselabs-0.1.13/src/greynoiselabs/cli/auth.py
--rw-r--r--   0        0        0     7372 2023-07-28 16:51:18.329064 greynoiselabs-0.1.13/src/greynoiselabs/cli/main.py
--rw-r--r--   0        0        0     2856 1970-01-01 00:00:00.000000 greynoiselabs-0.1.13/PKG-INFO
...
### Comparing `greynoiselabs-0.1.13/LICENSE` & `greynoiselabs-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/__init__.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/__init__.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/async_base_client.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/async_base_client.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/base_model.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/base_model.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/client.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/client.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/exceptions.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/exceptions.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/get_c2s.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_c2s.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/get_i_ps.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_popular_i_ps.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/get_knocks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_knocks.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/get_noise_ranks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_noise_ranks.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/get_requests.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_requests.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/noise_rank.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/noise_rank.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/top_h_t_t_p_requests.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_h_t_t_p_requests.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/api/top_knocks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_knocks.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/cli/auth.py` & `greynoiselabs-0.1.7/src/greynoiselabs/cli/auth.py`
...
### Comparing `greynoiselabs-0.1.13/src/greynoiselabs/cli/main.py` & `greynoiselabs-0.1.7/src/greynoiselabs/cli/main.py`
