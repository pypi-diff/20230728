# Comparing `tmp/greynoiselabs-0.1.19.tar.gz` & `tmp/greynoiselabs-0.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "greynoiselabs-0.1.19.tar", max compression
+gzip compressed data, was "greynoiselabs-0.1.7.tar", last modified: Thu Jul 27 18:38:35 2023, max compression
```

## Comparing `greynoiselabs-0.1.19.tar` & `greynoiselabs-0.1.7.tar`

### file list

```diff
@@ -1,26 +1,41 @@
--rw-r--r--   0        0        0     1079 2023-06-16 04:21:17.985676 greynoiselabs-0.1.19/LICENSE
--rw-r--r--   0        0        0     1278 2023-07-28 18:48:58.574889 greynoiselabs-0.1.19/README.rst
--rw-r--r--   0        0        0     2317 2023-07-28 18:58:26.039744 greynoiselabs-0.1.19/pyproject.toml
--rw-r--r--   0        0        0        0 2023-07-27 04:05:43.447421 greynoiselabs-0.1.19/src/greynoiselabs/__init__.py
--rw-r--r--   0        0        0     1611 2023-07-28 17:52:53.932529 greynoiselabs-0.1.19/src/greynoiselabs/api/__init__.py
--rw-r--r--   0        0        0     7371 2023-07-28 17:52:53.933179 greynoiselabs-0.1.19/src/greynoiselabs/api/async_base_client.py
--rw-r--r--   0        0        0     1951 2023-07-28 17:52:53.933784 greynoiselabs-0.1.19/src/greynoiselabs/api/base_model.py
--rw-r--r--   0        0        0     4296 2023-07-28 17:52:53.934349 greynoiselabs-0.1.19/src/greynoiselabs/api/client.py
--rw-r--r--   0        0        0       84 2023-07-28 17:52:53.934583 greynoiselabs-0.1.19/src/greynoiselabs/api/enums.py
--rw-r--r--   0        0        0     2366 2023-07-28 17:52:53.934939 greynoiselabs-0.1.19/src/greynoiselabs/api/exceptions.py
--rw-r--r--   0        0        0      461 2023-07-28 17:52:53.935238 greynoiselabs-0.1.19/src/greynoiselabs/api/generate_g_n_q_l.py
--rw-r--r--   0        0        0      593 2023-07-28 17:52:53.935602 greynoiselabs-0.1.19/src/greynoiselabs/api/get_c2s.py
--rw-r--r--   0        0        0      698 2023-07-28 17:52:53.935786 greynoiselabs-0.1.19/src/greynoiselabs/api/get_i_ps.py
--rw-r--r--   0        0        0      775 2023-07-28 17:52:53.935960 greynoiselabs-0.1.19/src/greynoiselabs/api/get_knocks.py
--rw-r--r--   0        0        0      689 2023-07-28 17:52:53.936152 greynoiselabs-0.1.19/src/greynoiselabs/api/get_noise_ranks.py
--rw-r--r--   0        0        0      755 2023-07-28 17:52:53.936344 greynoiselabs-0.1.19/src/greynoiselabs/api/get_requests.py
--rw-r--r--   0        0        0      221 2023-07-28 17:52:53.936513 greynoiselabs-0.1.19/src/greynoiselabs/api/input_types.py
--rw-r--r--   0        0        0      942 2023-07-27 01:19:27.930060 greynoiselabs-0.1.19/src/greynoiselabs/api/noise_rank.py
--rw-r--r--   0        0        0      220 2023-07-28 17:52:53.936697 greynoiselabs-0.1.19/src/greynoiselabs/api/scalars.py
--rw-r--r--   0        0        0     1138 2023-07-27 01:19:27.930299 greynoiselabs-0.1.19/src/greynoiselabs/api/top_h_t_t_p_requests.py
--rw-r--r--   0        0        0     1060 2023-07-27 01:19:27.930417 greynoiselabs-0.1.19/src/greynoiselabs/api/top_knocks.py
--rw-r--r--   0        0        0      993 2023-07-27 01:19:27.930530 greynoiselabs-0.1.19/src/greynoiselabs/api/top_popular_i_ps.py
--rw-r--r--   0        0        0        0 2023-07-27 03:55:22.108240 greynoiselabs-0.1.19/src/greynoiselabs/cli/__init__.py
--rwxr-xr-x   0        0        0     5840 2023-07-28 18:10:03.439937 greynoiselabs-0.1.19/src/greynoiselabs/cli/auth.py
--rw-r--r--   0        0        0     7371 2023-07-28 17:52:53.937221 greynoiselabs-0.1.19/src/greynoiselabs/cli/main.py
--rw-r--r--   0        0        0     2930 1970-01-01 00:00:00.000000 greynoiselabs-0.1.19/PKG-INFO
...
### Comparing `greynoiselabs-0.1.19/LICENSE` & `greynoiselabs-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/__init__.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/__init__.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/async_base_client.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/async_base_client.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/base_model.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/base_model.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/client.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/client.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/exceptions.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/exceptions.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/get_c2s.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_c2s.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/get_i_ps.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_popular_i_ps.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/get_knocks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_knocks.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/get_noise_ranks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_noise_ranks.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/get_requests.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/get_requests.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/noise_rank.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/noise_rank.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/top_h_t_t_p_requests.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_h_t_t_p_requests.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/api/top_knocks.py` & `greynoiselabs-0.1.7/src/greynoiselabs/api/top_knocks.py`

 * *Files identical despite different names*

### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/cli/auth.py` & `greynoiselabs-0.1.7/src/greynoiselabs/cli/auth.py`
...
### Comparing `greynoiselabs-0.1.19/src/greynoiselabs/cli/main.py` & `greynoiselabs-0.1.7/src/greynoiselabs/cli/main.py`
...
### Comparing `greynoiselabs-0.1.19/PKG-INFO` & `greynoiselabs-0.1.7/PKG-INFO`
...
-Requires-Dist: auth0-python (==4.4.0)
-Requires-Dist: colorama (==0.4.6)
-Requires-Dist: httpx (==0.24.1)
-Requires-Dist: jsonlines (==3.1.0)
-Requires-Dist: merge_args (==0.1.5)
...
-Project-URL: Documentation, https://api.labs.greynoise.io/
-Project-URL: Repository, https://github.com/GreyNoise-Intelligence/greynoiselabs
