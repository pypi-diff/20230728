# Comparing `tmp/cat_data_tools-0.1.0.tar.gz` & `tmp/cat_data_tools-0.4.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "cat_data_tools-0.1.0.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
+gzip compressed data, was "cat_data_tools-0.4.0.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
```

## Comparing `cat_data_tools-0.1.0.tar` & `cat_data_tools-0.4.0.tar`

### file list

```diff
@@ -1,6 +1,5 @@
--rw-r--r--   0        0        0      353 2023-07-28 17:57:01.764252 cat_data_tools-0.1.0/README.md
--rw-r--r--   0        0        0      125 2023-07-28 17:57:01.764252 cat_data_tools-0.1.0/cat_data_tools/__init__.py
--rw-r--r--   0        0        0      588 2023-07-28 17:57:01.764252 cat_data_tools-0.1.0/cat_data_tools/cli.py
--rw-r--r--   0        0        0     1772 2023-07-28 17:57:01.764252 cat_data_tools-0.1.0/cat_data_tools/filter_data_by_month.py
--rw-r--r--   0        0        0      475 2023-07-28 17:57:01.768252 cat_data_tools-0.1.0/pyproject.toml
--rw-r--r--   0        0        0      791 1970-01-01 00:00:00.000000 cat_data_tools-0.1.0/PKG-INFO
...
### Comparing `cat_data_tools-0.1.0/PKG-INFO` & `cat_data_tools-0.4.0/PKG-INFO`
...
```diff
@@ -1,10 +1,9 @@
-Metadata-Version: 2.1 Name: cat_data_tools Version: 0.1.0 Summary: A template
