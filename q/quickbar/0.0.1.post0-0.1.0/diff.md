# Comparing `tmp/quickbar-0.0.1.post0.tar.gz` & `tmp/quickbar-0.1.0.tar.gz`
...
### Comparing `quickbar-0.0.1.post0/quickbar/.git/hooks/commit-msg.sample` & `quickbar-0.1.0/quickbar/.git/hooks/commit-msg.sample`
