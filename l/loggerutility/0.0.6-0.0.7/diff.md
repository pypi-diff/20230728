# Comparing `tmp/loggerutility-0.0.6-py3-none-any.whl.zip` & `tmp/loggerutility-0.0.7-py3-none-any.whl.zip`
...
## Comparing `loggerutility-0.0.6.dist-info/LICENCE.txt` & `loggerutility-0.0.7.dist-info/LICENCE.txt`

 * *Files identical despite different names*

## Comparing `loggerutility-0.0.6.dist-info/METADATA` & `loggerutility-0.0.7.dist-info/METADATA`
