# Comparing `tmp/pybsky-0.0.19.tar.gz` & `tmp/pybsky-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pybsky-0.0.19.tar", last modified: Fri Jul 28 12:25:01 2023, max compression
+gzip compressed data, was "pybsky-0.0.2.tar", last modified: Sun Jul 23 19:40:03 2023, max compression
```

## Comparing `pybsky-0.0.19.tar` & `pybsky-0.0.2.tar`

### file list

```diff
@@ -1,31 +1,27 @@
-drwxrwxrwx   0        0        0        0 2023-07-28 12:25:01.814031 pybsky-0.0.19/
--rw-rw-rw-   0        0        0     1100 2023-07-23 19:53:13.000000 pybsky-0.0.19/LICENSE
--rw-rw-rw-   0        0        0     1371 2023-07-28 12:25:01.813018 pybsky-0.0.19/PKG-INFO
--rw-rw-rw-   0        0        0      741 2023-07-28 11:37:14.000000 pybsky-0.0.19/README.md
-drwxrwxrwx   0        0        0        0 2023-07-28 12:25:01.782814 pybsky-0.0.19/pybsky/
--rw-rw-rw-   0        0        0       67 2023-07-27 23:24:08.000000 pybsky-0.0.19/pybsky/__init__.py
--rw-rw-rw-   0        0        0     3390 2023-07-28 08:27:29.000000 pybsky-0.0.19/pybsky/client.py
-drwxrwxrwx   0        0        0        0 2023-07-28 12:25:01.805508 pybsky-0.0.19/pybsky/core/
--rw-rw-rw-   0        0        0      101 2023-07-25 18:51:39.000000 pybsky-0.0.19/pybsky/core/__init__.py
--rw-rw-rw-   0        0        0      769 2023-07-28 08:27:10.000000 pybsky-0.0.19/pybsky/core/configs.py
--rw-rw-rw-   0        0        0      432 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/core/exceptions.py
--rw-rw-rw-   0        0        0     5947 2023-07-23 19:53:13.000000 pybsky-0.0.19/pybsky/core/user_agents.py
--rw-rw-rw-   0        0        0     1161 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/core/utils.py
-drwxrwxrwx   0        0        0        0 2023-07-28 12:25:01.812017 pybsky-0.0.19/pybsky/mixins/
--rw-rw-rw-   0        0        0      217 2023-07-28 07:23:56.000000 pybsky-0.0.19/pybsky/mixins/__init__.py
--rw-rw-rw-   0        0        0        0 2023-07-23 19:53:13.000000 pybsky-0.0.19/pybsky/mixins/base.py
--rw-rw-rw-   0        0        0     2158 2023-07-28 06:58:53.000000 pybsky-0.0.19/pybsky/mixins/feed.py
--rw-rw-rw-   0        0        0     2946 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/mixins/graph.py
--rw-rw-rw-   0        0        0     1587 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/mixins/login.py
--rw-rw-rw-   0        0        0     2189 2023-07-28 08:27:10.000000 pybsky-0.0.19/pybsky/mixins/post.py
--rw-rw-rw-   0        0        0      491 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/mixins/profile.py
--rw-rw-rw-   0        0        0      910 2023-07-28 08:27:10.000000 pybsky-0.0.19/pybsky/mixins/repo.py
--rw-rw-rw-   0        0        0      368 2023-07-27 23:24:50.000000 pybsky-0.0.19/pybsky/mixins/server.py
-drwxrwxrwx   0        0        0        0 2023-07-28 12:25:01.799717 pybsky-0.0.19/pybsky.egg-info/
--rw-rw-rw-   0        0        0     1371 2023-07-28 12:25:01.000000 pybsky-0.0.19/pybsky.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      547 2023-07-28 12:25:01.000000 pybsky-0.0.19/pybsky.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-07-28 12:25:01.000000 pybsky-0.0.19/pybsky.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       17 2023-07-28 12:25:01.000000 pybsky-0.0.19/pybsky.egg-info/requires.txt
--rw-rw-rw-   0        0        0        7 2023-07-28 12:25:01.000000 pybsky-0.0.19/pybsky.egg-info/top_level.txt
--rw-rw-rw-   0        0        0     1435 2023-07-28 12:24:51.000000 pybsky-0.0.19/pyproject.toml
--rw-rw-rw-   0        0        0       42 2023-07-28 12:25:01.814031 pybsky-0.0.19/setup.cfg
...
### Comparing `pybsky-0.0.19/LICENSE` & `pybsky-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `pybsky-0.0.19/PKG-INFO` & `pybsky-0.0.2/PKG-INFO`
...
### Comparing `pybsky-0.0.19/pybsky/core/user_agents.py` & `pybsky-0.0.2/pybsky/core/user_agents.py`

 * *Files identical despite different names*

### Comparing `pybsky-0.0.19/pybsky/core/utils.py` & `pybsky-0.0.2/pybsky/core/utils.py`
...
### Comparing `pybsky-0.0.19/pybsky/mixins/feed.py` & `pybsky-0.0.2/pybsky/mixins/feed.py`
...
### Comparing `pybsky-0.0.19/pybsky/mixins/login.py` & `pybsky-0.0.2/pybsky/mixins/login.py`
...
### Comparing `pybsky-0.0.19/pybsky.egg-info/PKG-INFO` & `pybsky-0.0.2/pybsky.egg-info/PKG-INFO`
...
### Comparing `pybsky-0.0.19/pyproject.toml` & `pybsky-0.0.2/pyproject.toml`
