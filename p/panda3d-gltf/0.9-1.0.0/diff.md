# Comparing `tmp/panda3d-gltf-0.9.tar.gz` & `tmp/panda3d-gltf-1.0.0.tar.gz`
...
+gzip compressed data, was "panda3d-gltf-1.0.0.tar", last modified: Fri Jul 28 19:26:00 2023, max compression
```

## Comparing `panda3d-gltf-0.9.tar` & `panda3d-gltf-1.0.0.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 19:26:00.019750 panda3d-gltf-1.0.0/
+-rw-r--r--   0 runner    (1001) docker     (123)     1515 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/LICENSE.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       82 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)     3880 2023-07-28 19:26:00.015750 panda3d-gltf-1.0.0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     3404 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 19:26:00.015750 panda3d-gltf-1.0.0/gltf/
+-rw-r--r--   0 runner    (1001) docker     (123)      203 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)    81509 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/_converter.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1421 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/_loader.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4104 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/cli.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1609 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/parseutils.py
+-rw-r--r--   0 runner    (1001) docker     (123)       22 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/version.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3480 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/gltf/viewer.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 19:26:00.015750 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     3880 2023-07-28 19:25:59.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      459 2023-07-28 19:26:00.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-28 19:25:59.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)      169 2023-07-28 19:25:59.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       82 2023-07-28 19:25:59.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        5 2023-07-28 19:25:59.000000 panda3d-gltf-1.0.0/panda3d_gltf.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)     1107 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-28 19:26:00.019750 panda3d-gltf-1.0.0/setup.cfg
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 19:26:00.015750 panda3d-gltf-1.0.0/tests/
+-rw-r--r--   0 runner    (1001) docker     (123)     1212 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/tests/test_cli.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1249 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/tests/test_converter.py
+-rw-r--r--   0 runner    (1001) docker     (123)      153 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/tests/test_glb.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1005 2023-07-28 19:25:39.000000 panda3d-gltf-1.0.0/tests/test_load.py
```
...
### Comparing `panda3d-gltf-0.9/LICENSE.txt` & `panda3d-gltf-1.0.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `panda3d-gltf-0.9/gltf/converter.py` & `panda3d-gltf-1.0.0/gltf/_converter.py`
...
### Comparing `panda3d-gltf-0.9/gltf/viewer.py` & `panda3d-gltf-1.0.0/gltf/viewer.py`
