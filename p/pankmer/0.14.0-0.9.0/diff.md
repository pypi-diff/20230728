# Comparing `tmp/pankmer-0.14.0.tar.gz` & `tmp/pankmer-0.9.0.tar.gz`
...
## Comparing `pankmer-0.14.0.tar` & `pankmer-0.9.0.tar`

### file list

```diff
@@ -1,34 +1,34 @@
--rw-r--r--   0        0        0      588 1970-01-01 00:00:00.000000 pankmer-0.14.0/rust/Cargo.toml
--rw-r--r--   0      501       20     2446 2023-06-01 18:28:18.000000 pankmer-0.14.0/rust/src/adj_matrix.rs
--rw-r--r--   0      501       20     3544 2023-07-14 17:37:45.000000 pankmer-0.14.0/rust/src/decompose_kmers.rs
--rw-r--r--   0      501       20    10338 2023-07-27 20:42:27.000000 pankmer-0.14.0/rust/src/get_kmers.rs
--rw-r--r--   0      501       20     2864 2023-07-27 20:25:40.000000 pankmer-0.14.0/rust/src/helpers.rs
--rw-r--r--   0      501       20     9199 2023-07-27 20:42:27.000000 pankmer-0.14.0/rust/src/lib.rs
--rw-r--r--   0      501       20     3946 2023-07-27 20:25:40.000000 pankmer-0.14.0/rust/src/measure.rs
--rw-r--r--   0      501       20     2667 2023-07-14 17:37:45.000000 pankmer-0.14.0/rust/src/mem_blocks.rs
--rw-r--r--   0      501       20     4779 2023-07-27 20:42:27.000000 pankmer-0.14.0/rust/src/metadata.rs
--rw-r--r--   0      501       20    12584 2023-07-27 22:21:43.000000 pankmer-0.14.0/rust/src/pkidx.rs
--rw-r--r--   0      501       20     6486 2023-07-27 22:21:43.000000 pankmer-0.14.0/rust/src/subset_index.rs
--rw-r--r--   0      501       20     1160 2023-07-27 20:42:27.000000 pankmer-0.14.0/pyproject.toml
--rw-r--r--   0      501       20    32404 2023-07-27 20:42:39.000000 pankmer-0.14.0/rust/Cargo.lock
--rw-r--r--   0      501       20     1313 2023-07-27 20:25:40.000000 pankmer-0.14.0/src/pankmer/parse_genomes_input.py
--rw-r--r--   0      501       20     7529 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/tree.py
--rw-r--r--   0      501       20     6157 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/collect.py
--rw-r--r--   0      501       20       58 2023-06-01 18:28:18.000000 pankmer-0.14.0/src/pankmer/version.py
--rw-r--r--   0      501       20      583 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/env.py
--rw-r--r--   0      501       20     3617 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/clustermap.py
--rw-r--r--   0      501       20      214 2023-06-01 18:28:18.000000 pankmer-0.14.0/src/pankmer/get_lower_bound.py
--rw-r--r--   0      501       20     6288 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/download.py
--rw-r--r--   0      501       20    33386 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/datasets.py
--rw-r--r--   0      501       20      313 2023-06-06 20:14:06.000000 pankmer-0.14.0/src/pankmer/__init__.py
--rw-r--r--   0      501       20     1683 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/adjacency_matrix.py
--rw-r--r--   0      501       20     1801 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/upset.py
--rw-r--r--   0      501       20      603 2023-07-27 20:25:40.000000 pankmer-0.14.0/src/pankmer/subset.py
--rw-r--r--   0      501       20      947 2023-07-14 17:37:45.000000 pankmer-0.14.0/src/pankmer/gzip_agnostic_open.py
--rw-r--r--   0      501       20    18614 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/reg_coverage.py
--rw-r--r--   0      501       20     3284 2023-07-14 17:37:45.000000 pankmer-0.14.0/src/pankmer/anchormap.py
--rw-r--r--   0      501       20      772 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/count.py
--rw-r--r--   0      501       20     2617 2023-07-27 20:25:40.000000 pankmer-0.14.0/src/pankmer/dryrun.py
--rw-r--r--   0      501       20    62648 2023-07-27 20:42:27.000000 pankmer-0.14.0/src/pankmer/pankmer.py
--rw-r--r--   0      501       20     8293 2023-07-27 20:42:27.000000 pankmer-0.14.0/README.md
--rw-r--r--   0        0        0     9304 1970-01-01 00:00:00.000000 pankmer-0.14.0/PKG-INFO
...
### Comparing `pankmer-0.14.0/pyproject.toml` & `pankmer-0.9.0/pyproject.toml`
...
+build-backend = "setuptools.build_meta"
 ...
 [project]
 name = "pankmer"
-version = "0.14.0" # Don't forget to match with Cargo.toml and docs/source/conf.py
...
### Comparing `pankmer-0.14.0/src/pankmer/tree.py` & `pankmer-0.9.0/src/pankmer/tree.py`
...
### Comparing `pankmer-0.14.0/src/pankmer/clustermap.py` & `pankmer-0.9.0/src/pankmer/clustermap.py`
...
### Comparing `pankmer-0.14.0/src/pankmer/adjacency_matrix.py` & `pankmer-0.9.0/src/pankmer/adjacency_matrix.py`
...
### Comparing `pankmer-0.14.0/src/pankmer/reg_coverage.py` & `pankmer-0.9.0/src/pankmer/reg_coverage.py`
...
### Comparing `pankmer-0.14.0/src/pankmer/count.py` & `pankmer-0.9.0/src/pankmer/count.py`
...
### Comparing `pankmer-0.14.0/src/pankmer/pankmer.py` & `pankmer-0.9.0/src/pankmer/pankmer.py`
