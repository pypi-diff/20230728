# Comparing `tmp/aioscrapy_redis-0.1.tar.gz` & `tmp/aioscrapy_redis-0.2.tar.gz`
...
### Comparing `aioscrapy_redis-0.1/aioscrapy_redis/utils/get_settings.py` & `aioscrapy_redis-0.2/aioscrapy_redis/utils/get_settings.py`
