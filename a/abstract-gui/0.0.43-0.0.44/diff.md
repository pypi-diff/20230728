# Comparing `tmp/abstract_gui-0.0.43-py3.11.egg` & `tmp/abstract_gui-0.0.44-py3.11.egg`
...
+Zip file size: 22792 bytes, number of entries: 20
+-rw-rw-r--  2.0 unx     3801 b- defN 23-Jul-27 17:07 EGG-INFO/PKG-INFO
+-rw-rw-r--  2.0 unx      505 b- defN 23-Jul-27 17:07 EGG-INFO/SOURCES.txt
+-rw-rw-r--  2.0 unx        1 b- defN 23-Jul-27 17:07 EGG-INFO/dependency_links.txt
+-rw-r--r--  2.0 unx        1 b- defN 23-Jul-27 17:07 EGG-INFO/not-zip-safe
+-rw-rw-r--  2.0 unx       31 b- defN 23-Jul-27 17:07 EGG-INFO/requires.txt
+-rw-rw-r--  2.0 unx       13 b- defN 23-Jul-27 17:07 EGG-INFO/top_level.txt
...
+-rw-r--r--  2.0 unx     5395 b- defN 23-Jul-27 17:07 abstract_gui/PyQt5/__pycache__/PyQt5_browser_window.cpython-311.pyc
+-rw-r--r--  2.0 unx      168 b- defN 23-Jul-27 17:07 abstract_gui/PyQt5/__pycache__/__init__.cpython-311.pyc
+-rw-r--r--  2.0 unx      162 b- defN 23-Jul-27 17:07 abstract_gui/__pycache__/__init__.cpython-311.pyc
+-rw-r--r--  2.0 unx     2527 b- defN 23-Jul-27 17:07 abstract_gui/__pycache__/main.cpython-311.pyc
...
+-rw-r--r--  2.0 unx    11192 b- defN 23-Jul-27 17:07 abstract_gui/simple_gui/gui_template.py
+-rw-r--r--  2.0 unx      396 b- defN 23-Jul-27 17:07 abstract_gui/simple_gui/__pycache__/__init__.cpython-311.pyc
+-rw-r--r--  2.0 unx     4542 b- defN 23-Jul-27 17:07 abstract_gui/simple_gui/__pycache__/gui_presets.cpython-311.pyc
+-rw-r--r--  2.0 unx    16255 b- defN 23-Jul-27 17:07 abstract_gui/simple_gui/__pycache__/gui_template.cpython-311.pyc
+20 files, 52161 bytes uncompressed, 19728 bytes compressed:  62.2%
```
...
-files sz: 11151
+moddate:  0xa7eac264 (Thu Jul 27 22:07:35 2023 UTC)
+files sz: 11192
 code
    argcount  : 0
    nlocals   : 0
...
+   229         576 LOAD_CONST              54 (<code object single_call, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 229>)
                578 MAKE_FUNCTION            0
...
+   243         582 LOAD_CONST              55 (<code object get_last_window, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 243>)
                584 MAKE_FUNCTION            0
                586 STORE_NAME              40 (get_last_window)
    
-   251         588 LOAD_CONST              69 ((None, 0, 5, None))
+   252         588 LOAD_CONST              69 ((None, 0, 5, None))
...
+               600 LOAD_CONST              59 (<code object while_progress, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 252>)
                602 MAKE_FUNCTION            5 (defaults, annotations)
                604 STORE_NAME              41 (while_progress)
    
-   274         606 LOAD_CONST              70 (('last_window', '', ''))
+   275         606 LOAD_CONST              70 (('last_window', '', ''))
...
+               660 LOAD_CONST              60 (<code object update, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 275>)
                662 MAKE_FUNCTION            5 (defaults, annotations)
                664 STORE_NAME              42 (update)
    
-   289         666 LOAD_CONST              71 (('last_window', ''))
+   290         666 LOAD_CONST              71 (('last_window', ''))
...
+               716 LOAD_CONST              61 (<code object get_value, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 290>)
                718 MAKE_FUNCTION            5 (defaults, annotations)
                720 STORE_NAME              43 (get_value)
    
-   309         722 LOAD_CONST              71 (('last_window', ''))
+   310         722 LOAD_CONST              71 (('last_window', ''))
...
+               772 LOAD_CONST              62 (<code object get_event, file "build/bdist.linux-x86_64/egg/abstract_gui/simple_gui/gui_template.py", line 310>)
...
-            0001007c015300
+            00ab010000000000000000723e7c00a00200000000000000000000000000
+            00000000000000a6000000ab0000000000000000005c0200007d027d037c
+            0364016b030000000072027c037d017407000000000000000000007c02a6
+            010000ab01000000000000000072016e0f7403000000000000000000007c
+            00a6010000ab010000000000000000b03e7409000000000000000000007c
+            00a6010000ab01000000000000000001007c015300
          210           0 RESUME                   0
...
+                      70 POP_JUMP_FORWARD_IF_FALSE    62 (to 196)
...
+                     116 STORE_FAST               3 (values)
+         
+         222         118 LOAD_FAST                3 (values)
...
+                     148 PRECALL                  1
+                     152 CALL                     1
+                     162 POP_JUMP_FORWARD_IF_FALSE     1 (to 166)
+         
+         225         164 JUMP_FORWARD            15 (to 196)
...
-                     200 CALL                     1
-                     210 POP_TOP
+         220     >>  166 LOAD_GLOBAL              3 (NULL + verify_window)
+                     178 LOAD_FAST                0 (win)
+                     180 PRECALL                  1
+                     184 CALL                     1
+                     194 POP_JUMP_BACKWARD_IF_TRUE    62 (to 72)
+         
+         226     >>  196 LOAD_GLOBAL              9 (NULL + close_window)
+                     208 LOAD_FAST                0 (win)
+                     210 PRECALL                  1
+                     214 CALL                     1
+                     224 POP_TOP
...
-                     214 RETURN_VALUE
+         227         226 LOAD_FAST                1 (values_all)
+                     228 RETURN_VALUE
          consts
             "\n    Executes a while loop for handling basic events in a PySimpleGUI window.\n\n    Args:\n        win: The window to handle events for. If not provided, it uses the 'window' global object.\n    "
             None
...
+         lnotab 0x02070401040120011e012e010c0104011e0102fb1e061e01
       code
          argcount  : 1
          nlocals   : 3
          stacksize : 2
...
+         250           2 LOAD_GLOBAL              1 (NULL + ret_globals)
...
+         266         114 LOAD_GLOBAL              7 (NULL + win_closed)
...
+         267     >>  174 JUMP_FORWARD            83 (to 342)
          
-         267     >>  176 LOAD_FAST                0 (win)
+         268     >>  176 LOAD_FAST                0 (win)
...
+         269         220 LOAD_GLOBAL             11 (NULL + update_progress)
                      232 LOAD_FAST                0 (win)
...
+         272         302 LOAD_FAST                2 (step)
                      304 LOAD_CONST               8 (-1)
                      306 BINARY_OP               18 (*=)
                      310 STORE_FAST               2 (step)
          
-         263     >>  312 LOAD_GLOBAL              3 (NULL + verify_window)
+         264     >>  312 LOAD_GLOBAL              3 (NULL + verify_window)
                      324 LOAD_FAST                0 (win)
                      326 PRECALL                  1
                      330 CALL                     1
...
+         273     >>  342 LOAD_GLOBAL             15 (NULL + close_window)
                      354 LOAD_FAST                0 (win)
                      356 PRECALL                  1
                      360 CALL                     1
                      370 POP_TOP
...
+         284           2 LOAD_GLOBAL              1 (NULL + get_all_windows)
                       14 PRECALL                  0
                       18 CALL                     0
                       28 STORE_FAST               3 (all_windows)
          
-         284          30 LOAD_FAST                3 (all_windows)
+         285          30 LOAD_FAST                3 (all_windows)
...
+         286          98 LOAD_GLOBAL              5 (NULL + type)
                      110 LOAD_FAST                2 (obj)
                      112 PRECALL                  1
                      116 CALL                     1
...
+         287         142 LOAD_FAST                3 (all_windows)
...
+         288     >>  222 LOAD_GLOBAL              9 (NULL + update_registry)
...
+         304         122 LOAD_GLOBAL              7 (NULL + update_read)
...
+         321           2 LOAD_GLOBAL              1 (NULL + get_all_windows)
                       14 PRECALL                  0
                       18 CALL                     0
                       28 STORE_FAST               2 (all_windows)
          
-         321          30 LOAD_FAST                0 (curr_win)
+         322          30 LOAD_FAST                0 (curr_win)
                       32 STORE_FAST               3 (win_name)
          
-         322          34 LOAD_GLOBAL              3 (NULL + type)
+         323          34 LOAD_GLOBAL              3 (NULL + type)
                       46 LOAD_FAST                0 (curr_win)
                       48 PRECALL                  1
                       52 CALL                     1
                       62 LOAD_GLOBAL              3 (NULL + type)
...
+         324         122 LOAD_GLOBAL              7 (NULL + update_read)
                      134 LOAD_FAST                0 (curr_win)
                      136 PRECALL                  1
                      140 CALL                     1
                      150 POP_TOP
...
+         325         152 LOAD_CONST               1 ('last_window')
                      154 STORE_FAST               3 (win_name)
          
-         325     >>  156 LOAD_FAST                2 (all_windows)
+         326     >>  156 LOAD_FAST                2 (all_windows)
                      158 LOAD_FAST                3 (win_name)
                      160 BINARY_SUBSCR
                      170 STORE_FAST               4 (curr_js)
          
-         326         172 LOAD_FAST                4 (curr_js)
+         327         172 LOAD_FAST                4 (curr_js)
...
+      0a160d0e0c120d160e160e220e060f4615100e5e170813060e060912173c
       0f3814
```
