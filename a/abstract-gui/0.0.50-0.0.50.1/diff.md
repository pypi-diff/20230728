# Comparing `tmp/abstract_gui-0.0.50.tar.gz` & `tmp/abstract_gui-0.0.50.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "abstract_gui-0.0.50.tar", last modified: Thu Jul 27 23:30:05 2023, max compression
+gzip compressed data, was "abstract_gui-0.0.50.1.tar", last modified: Thu Jul 27 23:31:21 2023, max compression
```

## Comparing `abstract_gui-0.0.50.tar` & `abstract_gui-0.0.50.1.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.806172 abstract_gui-0.0.50/
--rw-r--r--   0 root         (0) root         (0)     3800 2023-07-27 23:30:05.806172 abstract_gui-0.0.50/PKG-INFO
--rw-rw-r--   0 root         (0) root         (0)     3065 2023-05-30 02:10:16.000000 abstract_gui-0.0.50/README.md
--rw-rw-r--   0 root         (0) root         (0)       85 2023-05-31 01:51:39.000000 abstract_gui-0.0.50/pyproject.toml
--rw-r--r--   0 root         (0) root         (0)       38 2023-07-27 23:30:05.806172 abstract_gui-0.0.50/setup.cfg
--rw-rw-r--   0 root         (0) root         (0)     1122 2023-07-27 23:30:00.000000 abstract_gui-0.0.50/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.802173 abstract_gui-0.0.50/src/
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.802173 abstract_gui-0.0.50/src/abstract_gui/
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.806172 abstract_gui-0.0.50/src/abstract_gui/PyQt5/
--rw-rw-r--   0 root         (0) root         (0)     2500 2023-05-26 21:54:16.000000 abstract_gui-0.0.50/src/abstract_gui/PyQt5/PyQt5_browser_window.py
--rw-rw-r--   0 root         (0) root         (0)        0 2023-05-26 02:06:40.000000 abstract_gui-0.0.50/src/abstract_gui/PyQt5/__init__.py
--rw-rw-r--   0 root         (0) root         (0)        0 2023-05-31 05:17:43.000000 abstract_gui-0.0.50/src/abstract_gui/__init__.py
--rw-rw-r--   0 root         (0) root         (0)     1294 2023-05-29 11:40:08.000000 abstract_gui-0.0.50/src/abstract_gui/main.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.806172 abstract_gui-0.0.50/src/abstract_gui/simple_gui/
--rw-rw-r--   0 root         (0) root         (0)      138 2023-05-31 04:26:08.000000 abstract_gui-0.0.50/src/abstract_gui/simple_gui/__init__.py
--rw-rw-r--   0 root         (0) root         (0)     3240 2023-05-31 14:39:25.000000 abstract_gui-0.0.50/src/abstract_gui/simple_gui/gui_presets.py
--rw-rw-r--   0 root         (0) root         (0)    11726 2023-07-27 23:29:21.000000 abstract_gui-0.0.50/src/abstract_gui/simple_gui/gui_template.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-27 23:30:05.802173 abstract_gui-0.0.50/src/abstract_gui.egg-info/
--rw-rw-r--   0 root         (0) root         (0)     3800 2023-07-27 23:30:05.000000 abstract_gui-0.0.50/src/abstract_gui.egg-info/PKG-INFO
--rw-rw-r--   0 root         (0) root         (0)      505 2023-07-27 23:30:05.000000 abstract_gui-0.0.50/src/abstract_gui.egg-info/SOURCES.txt
--rw-rw-r--   0 root         (0) root         (0)        1 2023-07-27 23:30:05.000000 abstract_gui-0.0.50/src/abstract_gui.egg-info/dependency_links.txt
--rw-rw-r--   0 root         (0) root         (0)       31 2023-07-27 23:30:05.000000 abstract_gui-0.0.50/src/abstract_gui.egg-info/requires.txt
--rw-rw-r--   0 root         (0) root         (0)       13 2023-07-27 23:30:05.000000 abstract_gui-0.0.50/src/abstract_gui.egg-info/top_level.txt
...
### Comparing `abstract_gui-0.0.50/PKG-INFO` & `abstract_gui-0.0.50.1/PKG-INFO`
...
### Comparing `abstract_gui-0.0.50/README.md` & `abstract_gui-0.0.50.1/README.md`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.50/setup.py` & `abstract_gui-0.0.50.1/setup.py`
...
### Comparing `abstract_gui-0.0.50/src/abstract_gui/PyQt5/PyQt5_browser_window.py` & `abstract_gui-0.0.50.1/src/abstract_gui/PyQt5/PyQt5_browser_window.py`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.50/src/abstract_gui/main.py` & `abstract_gui-0.0.50.1/src/abstract_gui/main.py`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.50/src/abstract_gui/simple_gui/gui_presets.py` & `abstract_gui-0.0.50.1/src/abstract_gui/simple_gui/gui_presets.py`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.50/src/abstract_gui/simple_gui/gui_template.py` & `abstract_gui-0.0.50.1/src/abstract_gui/simple_gui/gui_template.py`
...
### Comparing `abstract_gui-0.0.50/src/abstract_gui.egg-info/PKG-INFO` & `abstract_gui-0.0.50.1/src/abstract_gui.egg-info/PKG-INFO`
