# Comparing `tmp/sparkautomapper-1.1.2.tar.gz` & `tmp/sparkautomapper-2.0.0.tar.gz`
...
### Comparing `sparkautomapper-1.1.2/LICENSE` & `sparkautomapper-2.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/PKG-INFO` & `sparkautomapper-2.0.0/PKG-INFO`
...
### Comparing `sparkautomapper-1.1.2/README.md` & `sparkautomapper-2.0.0/README.md`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/setup.py` & `sparkautomapper-2.0.0/setup.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/automapper.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/automapper.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/automapper_analysis_exception.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/automapper_analysis_exception.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/automapper_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/automapper_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/check_schema_result.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/check_schema_result.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/column_spec_wrapper.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/column_spec_wrapper.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/columns.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/columns.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/complex.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/complex.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/container.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/container.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/with_column.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/with_column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/automappers/with_column_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/automappers/with_column_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/amount.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/amount.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/array.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/array.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/array_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/array_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/array_distinct.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/array_distinct.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/array_max.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/array_max.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/base64.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/base64.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/boolean.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/boolean.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/cast_to_type.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/cast_to_type.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/coalesce.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/coalesce.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/column.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/column_wrapper.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/column_wrapper.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/complex/complex.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/complex/complex.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/complex/complex_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/complex/complex_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/complex/struct_type.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/complex/struct_type.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/concat.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/concat.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/cross_column_filter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/cross_column_filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/data_type_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/data_type_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/date.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/date.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/date_format.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/date_format.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/datetime.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/datetime.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/decimal.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/decimal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/exists.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/exists.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/expression.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/expression.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/field.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/field.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/filter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/first.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/first.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/first_valid_column.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/first_valid_column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/flatten.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/flatten.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/float.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/float.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/hash.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/hash.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_column_exists.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_column_exists.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_not.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_not.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_not_null.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_not_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_not_null_or_empty.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_not_null_or_empty.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/if_regex.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/if_regex.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/join_using_delimiter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/join_using_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/list.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/list.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/literal.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/literal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/lpad.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/lpad.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/map.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/map.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/nested_array_filter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/nested_array_filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/null_if_empty.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/null_if_empty.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/null_remover.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/null_remover.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/number.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/number.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/regex_extract.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/regex_extract.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/regex_replace.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/regex_replace.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/split_by_delimiter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/split_by_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/substring.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/substring.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/substring_by_delimiter.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/substring_by_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/text_like_base.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/text_like_base.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/to_json.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/to_json.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/transform.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/transform.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/trim.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/trim.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/data_types/unix_timestamp.py` & `sparkautomapper-2.0.0/spark_auto_mapper/data_types/unix_timestamp.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/helpers/automapper_helpers.py` & `sparkautomapper-2.0.0/spark_auto_mapper/helpers/automapper_helpers.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/helpers/capture_arguments.py` & `sparkautomapper-2.0.0/spark_auto_mapper/helpers/capture_arguments.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/helpers/expression_comparer.py` & `sparkautomapper-2.0.0/spark_auto_mapper/helpers/expression_comparer.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/helpers/python_keyword_cleaner.py` & `sparkautomapper-2.0.0/spark_auto_mapper/helpers/python_keyword_cleaner.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/helpers/value_parser.py` & `sparkautomapper-2.0.0/spark_auto_mapper/helpers/value_parser.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/type_definitions/defined_types.py` & `sparkautomapper-2.0.0/spark_auto_mapper/type_definitions/defined_types.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/type_definitions/native_types.py` & `sparkautomapper-2.0.0/spark_auto_mapper/type_definitions/native_types.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/spark_auto_mapper/type_definitions/wrapper_types.py` & `sparkautomapper-2.0.0/spark_auto_mapper/type_definitions/wrapper_types.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/sparkautomapper.egg-info/PKG-INFO` & `sparkautomapper-2.0.0/sparkautomapper.egg-info/PKG-INFO`
...
### Comparing `sparkautomapper-1.1.2/sparkautomapper.egg-info/SOURCES.txt` & `sparkautomapper-2.0.0/sparkautomapper.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/amount/test_automapper_amount.py` & `sparkautomapper-2.0.0/tests/amount/test_automapper_amount.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/amount/test_automapper_amount_typed.py` & `sparkautomapper-2.0.0/tests/amount/test_automapper_amount_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/array/test_automapper_array_typed.py` & `sparkautomapper-2.0.0/tests/array/test_automapper_array_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/array_distinct/test_automapper_array_distinct.py` & `sparkautomapper-2.0.0/tests/array_distinct/test_automapper_array_distinct.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/array_max/test_automapper_array_max.py` & `sparkautomapper-2.0.0/tests/array_max/test_automapper_array_max.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/base64/test_automapper_base64.py` & `sparkautomapper-2.0.0/tests/base64/test_automapper_base64.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/boolean/test_automapper_boolean.py` & `sparkautomapper-2.0.0/tests/boolean/test_automapper_boolean.py`
...
### Comparing `sparkautomapper-1.1.2/tests/boolean/test_automapper_boolean_typed.py` & `sparkautomapper-2.0.0/tests/boolean/test_automapper_boolean_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/cast/test_cast.py` & `sparkautomapper-2.0.0/tests/cast/test_cast.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/cast_to_type/test_automapper_cast_to_type_typed.py` & `sparkautomapper-2.0.0/tests/cast_to_type/test_automapper_cast_to_type_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/checkpointing/test_automapper_full_checkpointing.py` & `sparkautomapper-2.0.0/tests/checkpointing/test_automapper_full_checkpointing.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/coalesce/test_automapper_coalesce.py` & `sparkautomapper-2.0.0/tests/coalesce/test_automapper_coalesce.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/columns/test_automapper_columns.py` & `sparkautomapper-2.0.0/tests/columns/test_automapper_columns.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/complex/test_automapper_complex.py` & `sparkautomapper-2.0.0/tests/complex/test_automapper_complex.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/complex/test_automapper_complex_with_defined_class.py` & `sparkautomapper-2.0.0/tests/complex/test_automapper_complex_with_defined_class.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/complex/test_automapper_complex_with_extension.py` & `sparkautomapper-2.0.0/tests/complex/test_automapper_complex_with_extension.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/complex/test_automapper_complex_with_mappers.py` & `sparkautomapper-2.0.0/tests/complex/test_automapper_complex_with_mappers.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/complex/test_automapper_complex_with_skip_if_null.py` & `sparkautomapper-2.0.0/tests/complex/test_automapper_complex_with_skip_if_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/concat/test_automapper_add_array.py` & `sparkautomapper-2.0.0/tests/concat/test_automapper_add_array.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/concat/test_automapper_concat.py` & `sparkautomapper-2.0.0/tests/concat/test_automapper_concat.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/concat/test_automapper_concat_array.py` & `sparkautomapper-2.0.0/tests/concat/test_automapper_concat_array.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/concat/test_automapper_concat_multiple_items_structs_different_elements.py` & `sparkautomapper-2.0.0/tests/concat/test_automapper_concat_multiple_items_structs_different_elements.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/concat/test_automapper_concat_multiple_items_structs_different_elements_with_schema.py` & `sparkautomapper-2.0.0/tests/concat/test_automapper_concat_multiple_items_structs_different_elements_with_schema.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/conftest.py` & `sparkautomapper-2.0.0/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/copy_unmapped_properties/test_automapper_copy_unmapped_properties.py` & `sparkautomapper-2.0.0/tests/copy_unmapped_properties/test_automapper_copy_unmapped_properties.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/cross_column_filter/location.py` & `sparkautomapper-2.0.0/tests/cross_column_filter/location.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/cross_column_filter/test_cross_column_filter.py` & `sparkautomapper-2.0.0/tests/cross_column_filter/test_cross_column_filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/date/test_automapper_date_column.py` & `sparkautomapper-2.0.0/tests/date/test_automapper_date_column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/date/test_automapper_date_column_typed.py` & `sparkautomapper-2.0.0/tests/date/test_automapper_date_column_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/date/test_automapper_date_literal.py` & `sparkautomapper-2.0.0/tests/date/test_automapper_date_literal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/date_format/test_automapper_date_format.py` & `sparkautomapper-2.0.0/tests/date_format/test_automapper_date_format.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/decimal_type/test_automapper_decimal.py` & `sparkautomapper-2.0.0/tests/decimal_type/test_automapper_decimal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/decimal_type/test_automapper_decimal_typed.py` & `sparkautomapper-2.0.0/tests/decimal_type/test_automapper_decimal_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/duplicates_test/test_automapper_duplicates.py` & `sparkautomapper-2.0.0/tests/duplicates_test/test_automapper_duplicates.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/exists/test_automapper_exists.py` & `sparkautomapper-2.0.0/tests/exists/test_automapper_exists.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/field/test_automapper_field.py` & `sparkautomapper-2.0.0/tests/field/test_automapper_field.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/filter/test_automapper_filter.py` & `sparkautomapper-2.0.0/tests/filter/test_automapper_filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/first/test_automapper_first.py` & `sparkautomapper-2.0.0/tests/first/test_automapper_first.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/first_valid_column/test_automapper_first_valid_column.py` & `sparkautomapper-2.0.0/tests/first_valid_column/test_automapper_first_valid_column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/first_valid_column/test_automapper_first_valid_column_expressions.py` & `sparkautomapper-2.0.0/tests/first_valid_column/test_automapper_first_valid_column_expressions.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/flatten/test_automapper_flatten.py` & `sparkautomapper-2.0.0/tests/flatten/test_automapper_flatten.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/flatten/test_automapper_flatten_with_null.py` & `sparkautomapper-2.0.0/tests/flatten/test_automapper_flatten_with_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/hash/test_automapper_hash.py` & `sparkautomapper-2.0.0/tests/hash/test_automapper_hash.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_/test_automapper_if_.py` & `sparkautomapper-2.0.0/tests/if_/test_automapper_if_.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_/test_automapper_if_list.py` & `sparkautomapper-2.0.0/tests/if_/test_automapper_if_list.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_column_exists/test_automapper_if_column_exists.py` & `sparkautomapper-2.0.0/tests/if_column_exists/test_automapper_if_column_exists.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_not/test_automapper_if_not.py` & `sparkautomapper-2.0.0/tests/if_not/test_automapper_if_not.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_not/test_automapper_if_not_list.py` & `sparkautomapper-2.0.0/tests/if_not/test_automapper_if_not_list.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_not_null/test_automapper_if_not_null.py` & `sparkautomapper-2.0.0/tests/if_not_null/test_automapper_if_not_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_not_null_or_empty/test_automapper_if_not_null_or_empty.py` & `sparkautomapper-2.0.0/tests/if_not_null_or_empty/test_automapper_if_not_null_or_empty.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/if_regex/test_automapper_if_regex.py` & `sparkautomapper-2.0.0/tests/if_regex/test_automapper_if_regex.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/join_using_delimiter/test_automapper_join_using_delimiter.py` & `sparkautomapper-2.0.0/tests/join_using_delimiter/test_automapper_join_using_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/left/test_automapper_left.py` & `sparkautomapper-2.0.0/tests/left/test_automapper_left.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/addition/test_automapper_list_addition_multiple_items_structs_different_elements.py` & `sparkautomapper-2.0.0/tests/list/addition/test_automapper_list_addition_multiple_items_structs_different_elements.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/addition/test_automapper_list_addition_multiple_items_structs_different_elements_with_schema.py` & `sparkautomapper-2.0.0/tests/list/addition/test_automapper_list_addition_multiple_items_structs_different_elements_with_schema.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_multiple_items.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_multiple_items.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_multiple_items_structs.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_multiple_items_structs.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_multiple_items_structs_different_elements.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_multiple_items_structs_different_elements.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_multiple_items_structs_different_elements_with_schema.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_multiple_items_structs_different_elements_with_schema.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_multiple_items_with_null.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_multiple_items_with_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_single_item.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_single_item.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/list/test_automapper_list_single_item_with_mapper.py` & `sparkautomapper-2.0.0/tests/list/test_automapper_list_single_item_with_mapper.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/lpad/test_auto_mapper_lpad.py` & `sparkautomapper-2.0.0/tests/lpad/test_auto_mapper_lpad.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/map/test_automapper_map.py` & `sparkautomapper-2.0.0/tests/map/test_automapper_map.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/map/test_automapper_map_col_default.py` & `sparkautomapper-2.0.0/tests/map/test_automapper_map_col_default.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/map/test_automapper_map_no_default.py` & `sparkautomapper-2.0.0/tests/map/test_automapper_map_no_default.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/map/test_automapper_map_null.py` & `sparkautomapper-2.0.0/tests/map/test_automapper_map_null.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/multiple_columns/test_automapper_multiple_columns.py` & `sparkautomapper-2.0.0/tests/multiple_columns/test_automapper_multiple_columns.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/multiple_columns/test_automapper_multiple_columns_simpler_syntax.py` & `sparkautomapper-2.0.0/tests/multiple_columns/test_automapper_multiple_columns_simpler_syntax.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/location.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/location.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/schedule.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/schedule.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/simple/test_automapper_nested_array_filter_simple.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/simple/test_automapper_nested_array_filter_simple.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/simple_with_array/test_automapper_nested_array_filter_simple_with_array.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/simple_with_array/test_automapper_nested_array_filter_simple_with_array.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/test_automapper_nested_array_filter.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/test_automapper_nested_array_filter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/nested_array_filter/test_automapper_nested_array_filter_expression_only.py` & `sparkautomapper-2.0.0/tests/nested_array_filter/test_automapper_nested_array_filter_expression_only.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/null_if_empty/test_automapper_null_if_empty.py` & `sparkautomapper-2.0.0/tests/null_if_empty/test_automapper_null_if_empty.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/null_remover/test_automapper_null_remover.py` & `sparkautomapper-2.0.0/tests/null_remover/test_automapper_null_remover.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/number/test_automapper_number.py` & `sparkautomapper-2.0.0/tests/number/test_automapper_number.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/number/test_automapper_number_typed.py` & `sparkautomapper-2.0.0/tests/number/test_automapper_number_typed.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/regex_extract/test_auto_mapper_regex_extract.py` & `sparkautomapper-2.0.0/tests/regex_extract/test_auto_mapper_regex_extract.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/regex_replace/test_auto_mapper_regex_replace.py` & `sparkautomapper-2.0.0/tests/regex_replace/test_auto_mapper_regex_replace.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/regex_replace/test_auto_mapper_regex_replace_unicode.py` & `sparkautomapper-2.0.0/tests/regex_replace/test_auto_mapper_regex_replace_unicode.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/right/test_automapper_right.py` & `sparkautomapper-2.0.0/tests/right/test_automapper_right.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/sanitize/test_auto_mapper_sanitize.py` & `sparkautomapper-2.0.0/tests/sanitize/test_auto_mapper_sanitize.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/schema_pruning/test_automapper_schema_pruning_with_defined_class.py` & `sparkautomapper-2.0.0/tests/schema_pruning/test_automapper_schema_pruning_with_defined_class.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/schema_pruning/test_automapper_schema_pruning_with_extension.py` & `sparkautomapper-2.0.0/tests/schema_pruning/test_automapper_schema_pruning_with_extension.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/schema_pruning/test_automapper_schema_pruning_with_extension_different_properties.py` & `sparkautomapper-2.0.0/tests/schema_pruning/test_automapper_schema_pruning_with_extension_different_properties.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/select_one/test_automapper_select_one.py` & `sparkautomapper-2.0.0/tests/select_one/test_automapper_select_one.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/split_by_delimiter/test_automapper_split_by_delimiter.py` & `sparkautomapper-2.0.0/tests/split_by_delimiter/test_automapper_split_by_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/split_by_delimiter/test_automapper_split_by_delimiter_and_transform.py` & `sparkautomapper-2.0.0/tests/split_by_delimiter/test_automapper_split_by_delimiter_and_transform.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/split_by_delimiter/test_automapper_split_by_delimiter_and_transform_fluent.py` & `sparkautomapper-2.0.0/tests/split_by_delimiter/test_automapper_split_by_delimiter_and_transform_fluent.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/string_after_delimiter/test_automapper_string_after_delimiter.py` & `sparkautomapper-2.0.0/tests/string_after_delimiter/test_automapper_string_after_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/string_before_delimiter/test_automapper_string_before_delimiter.py` & `sparkautomapper-2.0.0/tests/string_before_delimiter/test_automapper_string_before_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/struct_type/test_automapper_struct.py` & `sparkautomapper-2.0.0/tests/struct_type/test_automapper_struct.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/struct_type/test_automapper_struct_with_mappers.py` & `sparkautomapper-2.0.0/tests/struct_type/test_automapper_struct_with_mappers.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/substring_by_delimiter/test_automapper_substring_by_delimiter.py` & `sparkautomapper-2.0.0/tests/substring_by_delimiter/test_automapper_substring_by_delimiter.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/test_automapper_full.py` & `sparkautomapper-2.0.0/tests/test_automapper_full.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/test_automapper_full_no_keys.py` & `sparkautomapper-2.0.0/tests/test_automapper_full_no_keys.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/test_automapper_full_no_views.py` & `sparkautomapper-2.0.0/tests/test_automapper_full_no_views.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/test_automapper_full_view_exists.py` & `sparkautomapper-2.0.0/tests/test_automapper_full_view_exists.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/to_json/test_automapper_to_json.py` & `sparkautomapper-2.0.0/tests/to_json/test_automapper_to_json.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/transform/test_automapper_filter_and_transform.py` & `sparkautomapper-2.0.0/tests/transform/test_automapper_filter_and_transform.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/transform/test_automapper_filter_and_transform_fluent.py` & `sparkautomapper-2.0.0/tests/transform/test_automapper_filter_and_transform_fluent.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/transform/test_automapper_transform.py` & `sparkautomapper-2.0.0/tests/transform/test_automapper_transform.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/trim/test_auto_mapper_trim.py` & `sparkautomapper-2.0.0/tests/trim/test_auto_mapper_trim.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/unix_timestamp/test_automapper_unix_timestamp.py` & `sparkautomapper-2.0.0/tests/unix_timestamp/test_automapper_unix_timestamp.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/unix_timestamp/test_automapper_unix_timestamp_literal.py` & `sparkautomapper-2.0.0/tests/unix_timestamp/test_automapper_unix_timestamp_literal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/unix_timestamp/test_automapper_unix_timestamp_string.py` & `sparkautomapper-2.0.0/tests/unix_timestamp/test_automapper_unix_timestamp_string.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/withColumn/test_automapper_with_column.py` & `sparkautomapper-2.0.0/tests/withColumn/test_automapper_with_column.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/withColumn/test_automapper_with_column_expression.py` & `sparkautomapper-2.0.0/tests/withColumn/test_automapper_with_column_expression.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/withColumn/test_automapper_with_column_literal.py` & `sparkautomapper-2.0.0/tests/withColumn/test_automapper_with_column_literal.py`

 * *Files identical despite different names*

### Comparing `sparkautomapper-1.1.2/tests/withColumn/test_automapper_with_filter.py` & `sparkautomapper-2.0.0/tests/withColumn/test_automapper_with_filter.py`
