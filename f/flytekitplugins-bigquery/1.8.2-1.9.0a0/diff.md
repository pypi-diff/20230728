# Comparing `tmp/flytekitplugins-bigquery-1.8.2.tar.gz` & `tmp/flytekitplugins-bigquery-1.9.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins-bigquery-1.8.2.tar", last modified: Fri Jul 28 00:24:43 2023, max compression
+gzip compressed data, was "flytekitplugins-bigquery-1.9.0a0.tar", last modified: Thu Jul 20 18:58:14 2023, max compression
```

## Comparing `flytekitplugins-bigquery-1.8.2.tar` & `flytekitplugins-bigquery-1.9.0a0.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/
--rw-r--r--   0 runner    (1001) docker     (123)      810 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      535 2023-07-28 00:24:26.000000 flytekitplugins-bigquery-1.8.2/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/
--rw-r--r--   0 runner    (1001) docker     (123)      323 2023-07-28 00:24:26.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     4439 2023-07-28 00:24:26.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/agent.py
--rw-r--r--   0 runner    (1001) docker     (123)     3246 2023-07-28 00:24:26.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/task.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      810 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      469 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       55 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (123)       47 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:43.000000 flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-28 00:24:43.267863 flytekitplugins-bigquery-1.8.2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1270 2023-07-28 00:24:41.000000 flytekitplugins-bigquery-1.8.2/setup.py
...
### Comparing `flytekitplugins-bigquery-1.8.2/PKG-INFO` & `flytekitplugins-bigquery-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-bigquery-1.8.2/README.md` & `flytekitplugins-bigquery-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/agent.py` & `flytekitplugins-bigquery-1.9.0a0/flytekitplugins/bigquery/backend_plugin.py`
...
### Comparing `flytekitplugins-bigquery-1.8.2/flytekitplugins/bigquery/task.py` & `flytekitplugins-bigquery-1.9.0a0/flytekitplugins/bigquery/task.py`
...
### Comparing `flytekitplugins-bigquery-1.8.2/flytekitplugins_bigquery.egg-info/PKG-INFO` & `flytekitplugins-bigquery-1.9.0a0/flytekitplugins_bigquery.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-bigquery-1.8.2/setup.py` & `flytekitplugins-bigquery-1.9.0a0/setup.py`
