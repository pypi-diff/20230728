# Comparing `tmp/flytekitplugins-sqlalchemy-1.8.2.tar.gz` & `tmp/flytekitplugins-sqlalchemy-1.9.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins-sqlalchemy-1.8.2.tar", last modified: Fri Jul 28 00:24:52 2023, max compression
+gzip compressed data, was "flytekitplugins-sqlalchemy-1.9.0a0.tar", last modified: Thu Jul 20 18:58:27 2023, max compression
```

## Comparing `flytekitplugins-sqlalchemy-1.8.2.tar` & `flytekitplugins-sqlalchemy-1.9.0a0.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/
--rw-r--r--   0 runner    (1001) docker     (123)      789 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      528 2023-07-28 00:24:26.000000 flytekitplugins-sqlalchemy-1.8.2/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins/sqlalchemy/
--rw-r--r--   0 runner    (1001) docker     (123)      335 2023-07-28 00:24:26.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins/sqlalchemy/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     5607 2023-07-28 00:24:26.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins/sqlalchemy/task.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      789 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      400 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (123)       43 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:52.000000 flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-28 00:24:52.668074 flytekitplugins-sqlalchemy-1.8.2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1156 2023-07-28 00:24:41.000000 flytekitplugins-sqlalchemy-1.8.2/setup.py
...
### Comparing `flytekitplugins-sqlalchemy-1.8.2/PKG-INFO` & `flytekitplugins-sqlalchemy-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-sqlalchemy-1.8.2/README.md` & `flytekitplugins-sqlalchemy-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-sqlalchemy-1.8.2/flytekitplugins/sqlalchemy/task.py` & `flytekitplugins-sqlalchemy-1.9.0a0/flytekitplugins/sqlalchemy/task.py`
...
### Comparing `flytekitplugins-sqlalchemy-1.8.2/flytekitplugins_sqlalchemy.egg-info/PKG-INFO` & `flytekitplugins-sqlalchemy-1.9.0a0/flytekitplugins_sqlalchemy.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-sqlalchemy-1.8.2/setup.py` & `flytekitplugins-sqlalchemy-1.9.0a0/setup.py`
