# Comparing `tmp/flytekitplugins-papermill-1.8.2.tar.gz` & `tmp/flytekitplugins-papermill-1.9.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins-papermill-1.8.2.tar", last modified: Fri Jul 28 00:24:50 2023, max compression
+gzip compressed data, was "flytekitplugins-papermill-1.9.0a0.tar", last modified: Thu Jul 20 18:58:24 2023, max compression
```

## Comparing `flytekitplugins-papermill-1.8.2.tar` & `flytekitplugins-papermill-1.9.0a0.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:50.788032 flytekitplugins-papermill-1.8.2/
--rw-r--r--   0 runner    (1001) docker     (123)      796 2023-07-28 00:24:50.788032 flytekitplugins-papermill-1.8.2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      789 2023-07-28 00:24:26.000000 flytekitplugins-papermill-1.8.2/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:50.784032 flytekitplugins-papermill-1.8.2/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:50.788032 flytekitplugins-papermill-1.8.2/flytekitplugins/papermill/
--rw-r--r--   0 runner    (1001) docker     (123)      335 2023-07-28 00:24:26.000000 flytekitplugins-papermill-1.8.2/flytekitplugins/papermill/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    15569 2023-07-28 00:24:26.000000 flytekitplugins-papermill-1.8.2/flytekitplugins/papermill/task.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-28 00:24:50.788032 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      796 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      392 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (123)       60 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-28 00:24:50.000000 flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-28 00:24:50.788032 flytekitplugins-papermill-1.8.2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1205 2023-07-28 00:24:41.000000 flytekitplugins-papermill-1.8.2/setup.py
...
### Comparing `flytekitplugins-papermill-1.8.2/PKG-INFO` & `flytekitplugins-papermill-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-papermill-1.8.2/README.md` & `flytekitplugins-papermill-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-papermill-1.8.2/flytekitplugins/papermill/task.py` & `flytekitplugins-papermill-1.9.0a0/flytekitplugins/papermill/task.py`
...
### Comparing `flytekitplugins-papermill-1.8.2/flytekitplugins_papermill.egg-info/PKG-INFO` & `flytekitplugins-papermill-1.9.0a0/flytekitplugins_papermill.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-papermill-1.8.2/setup.py` & `flytekitplugins-papermill-1.9.0a0/setup.py`
