# Comparing `tmp/namekoplus-0.3.2.tar.gz` & `tmp/namekoplus-0.4.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "namekoplus-0.3.2.tar", last modified: Tue Jul 25 09:38:25 2023, max compression
+gzip compressed data, was "namekoplus-0.4.0.tar", last modified: Fri Jul 28 03:42:48 2023, max compression
```

## Comparing `namekoplus-0.3.2.tar` & `namekoplus-0.4.0.tar`

### file list

```diff
@@ -1,55 +1,69 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.725890 namekoplus-0.3.2/
--rw-r--r--   0 runner    (1001) docker     (123)     1066 2023-07-25 09:38:12.000000 namekoplus-0.3.2/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)      238 2023-07-25 09:38:12.000000 namekoplus-0.3.2/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     1526 2023-07-25 09:38:25.725890 namekoplus-0.3.2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      504 2023-07-25 09:38:12.000000 namekoplus-0.3.2/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.717889 namekoplus-0.3.2/namekoplus/
--rw-r--r--   0 runner    (1001) docker     (123)       40 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.717889 namekoplus-0.3.2/namekoplus/chassis/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/chassis/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      540 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/chassis/chassis.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.717889 namekoplus-0.3.2/namekoplus/chassis-agent/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/chassis-agent/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/chassis-agent/rabbitmq/
--rw-r--r--   0 runner    (1001) docker     (123)      560 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/chassis-agent/rabbitmq/docker-compose-rabbitmq.yml
--rw-r--r--   0 runner    (1001) docker     (123)     5475 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/command.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/all/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/all/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     3882 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/all/all_demo.py
--rw-r--r--   0 runner    (1001) docker     (123)      604 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/all/config.yml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/demo/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/demo/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      180 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/demo/config.yml
--rw-r--r--   0 runner    (1001) docker     (123)      440 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/demo/rpc_demo.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/event/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/event/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      569 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/event/config.yml
--rw-r--r--   0 runner    (1001) docker     (123)     1922 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/event/events_demo.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/http/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/http/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      604 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/http/config.yml
--rw-r--r--   0 runner    (1001) docker     (123)     1024 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/http/http_demo.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/rpc/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/rpc/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      569 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/rpc/config.yml
--rw-r--r--   0 runner    (1001) docker     (123)      804 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/rpc/rpc_demo.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/templates/timer/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/timer/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      569 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/timer/config.yml
--rw-r--r--   0 runner    (1001) docker     (123)      399 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/templates/timer/timer_demo.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/tests/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.721889 namekoplus-0.3.2/namekoplus/tests/unit/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/tests/unit/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      822 2023-07-25 09:38:12.000000 namekoplus-0.3.2/namekoplus/tests/unit/test_service.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 09:38:25.717889 namekoplus-0.3.2/namekoplus.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1526 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1267 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       54 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)      484 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-07-25 09:38:25.000000 namekoplus-0.3.2/namekoplus.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-25 09:38:25.725890 namekoplus-0.3.2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2392 2023-07-25 09:38:12.000000 namekoplus-0.3.2/setup.py
...
### Comparing `namekoplus-0.3.2/LICENSE` & `namekoplus-0.4.0/LICENSE`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/PKG-INFO` & `namekoplus-0.4.0/PKG-INFO`
...
### Comparing `namekoplus-0.3.2/namekoplus/chassis/chassis.py` & `namekoplus-0.4.0/namekoplus/chassis/chassis.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/chassis-agent/rabbitmq/docker-compose-rabbitmq.yml` & `namekoplus-0.4.0/namekoplus/chassis-agent/rabbitmq/docker-compose-rabbitmq.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/all/all_demo.py` & `namekoplus-0.4.0/namekoplus/templates/all/all_demo.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/all/config.yml` & `namekoplus-0.4.0/namekoplus/templates/all/config.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/event/config.yml` & `namekoplus-0.4.0/namekoplus/templates/event/config.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/event/events_demo.py` & `namekoplus-0.4.0/namekoplus/templates/event/events_demo.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/http/config.yml` & `namekoplus-0.4.0/namekoplus/templates/http/config.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/http/http_demo.py` & `namekoplus-0.4.0/namekoplus/templates/http/http_demo.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/rpc/config.yml` & `namekoplus-0.4.0/namekoplus/templates/rpc/config.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/rpc/rpc_demo.py` & `namekoplus-0.4.0/namekoplus/templates/rpc/rpc_demo.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/templates/timer/config.yml` & `namekoplus-0.4.0/namekoplus/templates/timer/config.yml`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus/tests/unit/test_service.py` & `namekoplus-0.4.0/namekoplus/tests/unit/test_service.py`

 * *Files identical despite different names*

### Comparing `namekoplus-0.3.2/namekoplus.egg-info/PKG-INFO` & `namekoplus-0.4.0/namekoplus.egg-info/PKG-INFO`
...
### Comparing `namekoplus-0.3.2/setup.py` & `namekoplus-0.4.0/setup.py`
